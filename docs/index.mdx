KhlnaSoft is a Code Intelligence platform that deeply understands your code, no matter how large or where it’s hosted, to power modern developer experiences.
...
<QuickLinks>
	...
	<QuickLink
		...
		imgAlt="Cody"
		title="Cody"
		description="Write, fix, and maintain code with KhlnaSoft’s AI coding assistant, Cody. "
	/>
	<QuickLink
		title="Deep Search"
		icon="plugins"
	...
	<QuickLink
		...
		description="Learn how to use KhlnaSoft."
	/>
	<QuickLink
		title="KhlnaSoft Tour"
		icon="codegraph"
		href="/getting-started/tour"
		description="Take a tour of KhlnaSoft’s features using real-world examples and use cases."
	/>
</QuickLinks>

## Main Features

Some of the main KhlnaSoft features include:
...
Stay in sync and get the latest news on KhlnaSoft products, technologies, and culture. [Read the blog →](https://khulnasoft.com/blog)

## Join our Community

If you have questions about anything related to KhlnaSoft, you're always welcome to ask in in our [Discord](https://discord.gg/s2qDtYGnAE), and [X](https://twitter.com/khulnasoft).
