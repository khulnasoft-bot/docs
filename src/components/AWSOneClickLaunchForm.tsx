...
export default function AWSOneClickLaunchForm() {
	...
	const handleSubmit = (event: {preventDefault: () => void}) => {
		...
		const url = `https://console.aws.amazon.com/cloudformation/home?region=${region}#/stacks/quickcreate?stackName=KhlnaSoft&templateURL=https://khulnasoft-cloudformation.s3.us-west-2.amazonaws.com/sg-basic.yaml`;
