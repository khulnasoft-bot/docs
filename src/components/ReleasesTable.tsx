...
export function DeprecatedReleasesTable() {
	const deprecatedReleases = [
		...
		{version: '4.0', date: 'September 2022', anchor: 'v401'},
		{
			version: '3.43',
			date: 'August 2022',
			url: 'https://github.com/khulnasoft/khulnasoft-public-snapshot/blob/main/CHANGELOG.md#3432'
		},
		{
			version: '3.42',
			date: 'July 2022',
			url: 'https://github.com/khulnasoft/khulnasoft-public-snapshot/blob/main/CHANGELOG.md#3422'
		},
		{
			version: '3.41',
			date: 'June 2022',
		...
		},
		{
			version: '3.40',
			date: 'May 2022',
			url: 'https://github.com/khulnasoft/khulnasoft-public-snapshot/blob/main/CHANGELOG.md#3402'
		},
		{
			version: '3.39',
			date: 'April 2022',
			url: 'https://github.com/khulnasoft/khulnasoft-public-snapshot/blob/main/CHANGELOG.md#3391'
		},
		{
			version: '3.38',
			date: 'March 2022',
		...
		},
		{
			version: '3.36',
			date: 'January 2022',
			url: 'https://github.com/khulnasoft/khulnasoft-public-snapshot/blob/main/CHANGELOG.md#3363'
		},
		{
			version: '3.35',
			date: 'December 2021',
			url: 'https://github.com/khulnasoft/khulnasoft-public-snapshot/blob/main/CHANGELOG.md#3352'
		},
		{
			version: '3.34',
			date: 'November 2021',
		...
		},
		{
			version: '3.33',
			date: 'October 2021',
			url: 'https://github.com/khulnasoft/khulnasoft-public-snapshot/blob/main/CHANGELOG.md#3332'
		},
		{
			version: '3.32',
			date: 'September 2021',
			url: 'https://github.com/khulnasoft/khulnasoft-public-snapshot/blob/main/CHANGELOG.md#3321'
		},
		{
			version: '3.31',
			date: 'August 2021',
