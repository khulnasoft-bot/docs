...
const fileLocal = `https://corsproxy.io/?${encodeURIComponent(
	`https://storage.googleapis.com/khulnasoft-resource-estimator/main_${version}.wasm`
)}`;

const fileProd = `https://storage.googleapis.com/khulnasoft-resource-estimator/main_${version}.wasm`;
...
const useScripts = (containerRef: any) => {
	useEffect(() => {
		...
		script.src =
			'https://storage.googleapis.com/khulnasoft-resource-estimator/go_1_18_wasm_exec.js';
		script.async = true;
