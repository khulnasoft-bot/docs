const redirectsData = [
	{
		...
		destination:
			'https://khulnasoft.com/docs/admin/executors/deploy_executors',
		permanent: true
	},
	{
		source: '/dev/roadmap',
		destination: 'https://khulnasoft.com/direction',
		permanent: true
	},
	{
		source: '/dev/code_reviews',
		destination:
			'https://docs.khulnasoft.com/dev/background-information/code_reviews',
		permanent: true
	},
	{
		source: '/dev/conduct',
		destination: 'https://khulnasoft.com/community/code_of_conduct',
		permanent: true
	},
	{
		source: '/dev/devrel_release_issue_template',
		destination:
			'https://khulnasoft.com/handbook/marketing/developer-relations/release_issue_template',
		permanent: true
	},
	{
		source: '/dev/documentation/separate_website',
		destination:
			'https://khulnasoft.com/handbook/engineering/distribution/separate_website',
		permanent: true
	},
	{
		source: '/dev/documentation/site',
		destination:
			'https://khulnasoft.com/handbook/engineering/distribution/update_khulnasoft_website',
		permanent: true
	},
	{
		source: '/dev/documentation/structure',
		destination:
			'https://khulnasoft.com/handbook/engineering/product_documentation',
		permanent: true
	},
	{
	...
	{
		source: '/dev/faq',
		destination: 'https://khulnasoft.com/community/faq',
		permanent: true
	},
	{
		source: '/dev/go_style_guide',
		destination:
			'https://docs.khulnasoft.com/dev/background-information/languages/go',
		permanent: true
	},
	{
		source: '/dev/incidents',
		destination: 'https://khulnasoft.com/handbook/engineering/incidents',
		permanent: true
	},
	{
		source: '/dev/open_source_open_company',
		destination:
			'https://khulnasoft.com/company#khulnasoft-open-product-open-company-open-source',
		permanent: true
	},
	{
		source: '/dev/patch_release_issue_template',
		destination:
			'https://khulnasoft.com/handbook/engineering/releases/patch_release_issue_template',
		permanent: true
	},
	{
		source: '/dev/product',
		destination: 'https://khulnasoft.com/handbook/product',
		permanent: true
	},
	{
		source: '/dev/product/personas',
		destination: 'https://khulnasoft.com/handbook/marketing/personas',
		permanent: true
	},
	{
		source: '/dev/release_issue_template',
		destination:
			'https://khulnasoft.com/handbook/engineering/releases/release_issue_template',
		permanent: true
	},
	{
		source: '/dev/releases',
		destination: 'https://khulnasoft.com/handbook/engineering/releases',
		permanent: true
	},
	{
		source: '/dev/retrospectives/3_0',
		destination: 'https://khulnasoft.com/handbook/retrospectives/3_0',
		permanent: true
	},
	{
		source: '/dev/retrospectives/3_0_beta',
		destination: 'https://khulnasoft.com/handbook/retrospectives/3_0_beta',
		permanent: true
	},
	{
		source: '/dev/retrospectives/3_2',
		destination: 'https://khulnasoft.com/retrospectives/3_2',
		permanent: true
	},
	{
		source: '/dev/retrospectives/3_3',
		destination: 'https://khulnasoft.com/retrospectives/3_3',
		permanent: true
	},
	{
		source: '/dev/retrospectives/3_4',
		destination: 'https://khulnasoft.com/retrospectives/3_4',
		permanent: true
	},
	{
		source: '/dev/retrospectives/3_5',
		destination: 'https://khulnasoft.com/retrospectives/3_5',
		permanent: true
	},
	{
		source: '/dev/retrospectives/3_6',
		destination: 'https://khulnasoft.com/retrospectives/3_6',
		permanent: true
	},
	{
		source: '/dev/retrospectives/3_7',
		destination: 'https://khulnasoft.com/retrospectives/3_7',
		permanent: true
	},
	{
		source: '/dev/retrospectives/3_8',
		destination: 'https://khulnasoft.com/retrospectives/3_8',
		permanent: true
	},
	{
		source: '/dev/retrospectives/3_9',
		destination: 'https://khulnasoft.com/retrospectives/3_9',
		permanent: true
	},
	{
		source: '/dev/retrospectives/customer_license_expiration',
		destination:
			'https://khulnasoft.com/retrospectives/customer_license_expiration',
		permanent: true
	},
	{
		source: '/dev/retrospectives',
		destination: 'https://khulnasoft.com/retrospectives',
		permanent: true
	},
	{
		source: '/dev/retrospectives/postgresql_upgrade',
		destination: 'https://khulnasoft.com/retrospectives/postgresql_upgrade',
		permanent: true
	},
	{
		source: '/dev/rfcs',
		destination: 'https://khulnasoft.com/handbook/communication/rfcs',
		permanent: true
	},
	{
		source: '/dev/style_guide',
		destination:
			'https://khulnasoft.com/handbook/communication/style_guide',
		permanent: true
	},
	{
		source: '/direction',
	...
	},
	{
		...
		destination: 'https://khulnasoft.com/handbook',
		permanent: true
	},
	{
		source: '/graphbook',
	...
	},
	{
		...
		destination:
			'https://khulnasoft.com/handbook/communication/company_meeting',
		permanent: true
	},
	{
		source: '/team/graphbook/travel',
		destination: 'https://khulnasoft.com/handbook/people-ops/travel',
		permanent: true
	},
	{
		source: '/team/gtm/devrel',
		destination:
			'https://khulnasoft.com/handbook/marketing/developer-relations',
		permanent: true
	},
	{
		source: '/team/gtm',
		destination: 'https://khulnasoft.com/handbook/sales',
		permanent: true
	},
	{
		source: '/team/gtm/support/diagnostics',
		destination: 'https://khulnasoft.com/handbook/support/diagnostics',
		permanent: true
	},
	{
		source: '/team/gtm/support',
		destination: 'https://khulnasoft.com/handbook/support',
		permanent: true
	},
	{
		source: '/team',
	...
	},
	{
		...
		destination: 'https://khulnasoft.com/handbook/engineering',
		permanent: true
	},
	{
	...
	},
	{
		...
		destination: 'https://khulnasoft.com/retrospectives/3_0',
		permanent: true
	},
	{
		source: '/team/product-dev/retrospectives/3_0_beta',
		destination: 'https://khulnasoft.com/retrospectives/3_0_beta',
		permanent: true
	},
	{
	...
	{
		source: '/adopt/comp',
		destination: 'https://khulnasoft.com/workflow',
		permanent: true
	},
	{
	...
	},
	{
		...
		destination:
			'https://docs.khulnasoft.com/@v5.3.0/admin/observability/alerts',
		permanent: false
	},
	{
		source: '/@v5.3.0/admin/observability/dashboards',
		destination:
			'https://docs.khulnasoft.com/@v5.3.0/admin/observability/dashboards',
		permanent: false
	},
	{
	...
	},
	{
		...
		destination:
			'https://khulnasoft.com/github.com/khulnasoft/scip-clang/-/blob/README.md#usage',
		permanent: true
	},
	{
	...
	{
		source: '/cody/autocomplete#configuring-on-khulnasoft-enterprise',
		destination:
			'/cody/capabilities/autocomplete#configure-autocomplete-on-an-enterprise-khulnasoft-instance',
		permanent: true
	},
	{
		source: '/cody/capabilities#configure-autocomplete-on-khulnasoft-enterprise',
		destination:
			'/cody/capabilities/autocomplete#configure-autocomplete-on-an-enterprise-khulnasoft-instance',
		permanent: true
	},
	...
	},
	{
		...
		destination: '/cody/clients/cody-with-khulnasoft',
		permanent: true
	},
	{
		source: '/cody/overview/cody-with-khulnasoft',
		destination: '/cody/clients/cody-with-khulnasoft',
		permanent: true
	},
	{
	...
	{
		source: '/cody/explanations/indexing#khulnasoft-enterprise',
		destination: '/cody/embeddings/embedding-index#khulnasoft-enterprise',
		permanent: true
	},
	{
		source: '/cody/core-concepts/embeddings/embedding-index#khulnasoft-enterprise',
		destination: '/cody/embeddings/embedding-index#khulnasoft-enterprise',
		permanent: true
	},
	{
		source: '/cody/explanations/indexing#khulnasoft-com',
		destination: '/cody/embeddings/embedding-index#khulnasoftcom',
		permanent: true
	},
	{
		source: '/cody/core-concepts/embeddings/embedding-index#khulnasoft-com',
		destination: '/cody/embeddings/embedding-index#khulnasoftcom',
		permanent: true
	},
	{
	...
	{
		source: '/cody/core-concepts/cody_gateway#using-cody-gateway-in-khulnasoft-enterprise',
		destination:
			'/cody/core-concepts/cody-gateway#using-cody-gateway-in-khulnasoft-enterprise',
		permanent: true
	},
	{
	...
	{
		source: '/code_navigation/how-to/adding_lsif_to_workflows#uploading-indexes-to-khulnasoftcom',
		destination:
			'/code-search/code-navigation/how-to/adding_lsif_to_workflows#uploading-indexes-to-khulnasoftcom',
		permanent: true
	},
...

	{
		...
		destination:
			'/code-search/code-navigation/writing_an_indexer#khulnasoft-recommended-indexers',
		permanent: true
	},
	...
	{
		source: '/admin/pricing#how-are-active-users-calculated-for-khulnasoft-cody',
		destination: '/cody/usage-and-pricing#billing-faqs-for-cody-enterprise',
		permanent: true
	},

	{
		source: '/admin/pricing#how-are-active-users-calculated-for-khulnasoft-code-search-and-code-intelligence-platform',
		destination:
			'/pricing/faqs#how-are-active-users-calculated-for-khulnasoft-code-search-and-code-intelligence-platform',
		permanent: true
	},
	...
	//Rmv embeddings permanentaly:https://khulnasoft.com/docs/cody/core-concepts/embeddings
	{
	...
	//Rmv Query types permanentaly:https://khulnasoft.com/docs/cody/capabilities/query-types
	{
...

	{
		...
		destination: 'https://khulnasoft.com/pricing',
		permanent: true
	},
