...
export const navigation: NavigationItem[] = [
				...
				sections: [
					{title: 'Quickstart', href: '/cody/quickstart'},
					{
						...
						subsections: [
							...
							{
								title: 'Cody for Web',
								href: '/cody/clients/cody-with-khulnasoft'
							}
						]
					},
					{
				...
				sections: [
					{title: 'Quickstart', href: '/batch-changes/quickstart'},
					{
						...
						subsections: [
							{
								title: 'KhlnaSoft UI',
								href: '/batch-changes/create-a-batch-change#on-your-khulnasoft-instance'
							},
							{
								title: 'KhlnaSoft CLI',
								href: '/batch-changes/create-a-batch-change#using-the-khulnasoft-cli'
							}
						]
					},
					{
	...
	},
	{
		...
		topics: [
			...
			{
				title: 'KhlnaSoft Model Provider',
				href: '/model-provider'
			},
			{
				title: 'Integrations',
	...
	},
	{
		...
		topics: [
			...
			{
				title: 'KhlnaSoft GraphQL API',
				href: '/api/graphql'
			},
			{
				title: 'KhlnaSoft Stream API',
				href: '/api/stream_api'
			},
			{
				title: 'KhlnaSoft MCP Server',
				href: '/api/mcp'
			}
		]
	},
	...
	},
	{
		...
		topics: [
			...
			{
				title: 'KhlnaSoft Accounts',
				href: '/khulnasoft-accounts'
			},
			{
				title: 'Changelog',
				href: 'https://khulnasoft.com/changelog'
			},
			{
