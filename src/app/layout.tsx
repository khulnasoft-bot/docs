...
export const metadata: Metadata = {
	metadataBase: new URL('https://khulnasoft.com'),
	title: {
		template: '%s - KhlnaSoft docs',
		default: 'KhlnaSoft docs'
	},
	description: 'Documentation for KhlnaSoft, the code intelligence platform.',
	other: {
	...
	openGraph: {
		images: [{url: 'https://khulnasoft.com/docs/khulnasoft-og-nw.png'}]
	}
};
		...
		>
			...
			>
				...
				<Script
					...
					runllm-name="KhlnaSoft Doc Assistant"
					runllm-position="BOTTOM_RIGHT"
					runllm-assistant-id="1119"
					runllm-theme-color="#FF5543"
					runllm-floating-button-text="Ask AI"
					runllm-brand-logo="https://storage.googleapis.com/khulnasoft-assets/Docs/Media/khulnasoft-pictogram-light.png"
					async
				/>
			</body>
