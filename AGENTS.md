# KhlnaSoft Docs - Agent Instructions
...
- **Configuration**:
    ...
    - Theme color: #FF5543 (KhlnaSoft brand color)
    - Button text: "Ask AI"
...
<Script
	...
	runllm-name="KhlnaSoft AI Assistant"
...
- **Assistant ID**: The `runllm-assistant-id` is currently set to "YOUR_ASSISTANT_ID" and needs to be updated with the actual KhlnaSoft runLLM assistant ID
- **Deployment**: After updating the assistant ID, add the deployment URL to the runLLM dashboard
- **Styling**: The widget inherits the site's theme and uses the KhlnaSoft brand color (#FF5543)
